...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(HotelReservationManagerException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleManagerException(HotelReservationManagerException exception){
